...
//セッションストレージ
let anime_hard_correct1 = sessionStorage.getItem('anime_hard_correct1');
function correct(){
	anime_hard_correct1++
	sessionStorage.setItem('anime_hard_correct1',anime_hard_correct1);
}

let anime_hard_incorrect1 = sessionStorage.getItem('anime_hard_incorrect1');
function incorrect(){
	anime_hard_incorrect1++
	sessionStorage.setItem('anime_hard_incorrect1',anime_hard_incorrect1);
}

let anime_hard_correct2 = sessionStorage.getItem('anime_hard_correct2');
function correctB(){
	anime_hard_correct2++
	sessionStorage.setItem('anime_hard_correct2',anime_hard_correct2);
}

let anime_hard_incorrect2 = sessionStorage.getItem('anime_hard_incorrect2');
function incorrectB(){
	anime_hard_incorrect2++
	sessionStorage.setItem('anime_hard_incorrect2',anime_hard_incorrect2);
}

let anime_hard_correct3 = sessionStorage.getItem('anime_hard_correct3');
function correctC(){
	anime_hard_correct3++
	sessionStorage.setItem('anime_hard_correct3',anime_hard_correct3);
}

let anime_hard_incorrect3 = sessionStorage.getItem('anime_hard_incorrect3');
function incorrectC(){
	anime_hard_incorrect3++
	sessionStorage.setItem('anime_hard_incorrect3',anime_hard_incorrect3);
}

let anime_hard_correct4 = sessionStorage.getItem('anime_hard_correct4');
function correctD(){
	anime_hard_correct4++
	sessionStorage.setItem('anime_hard_correct4',anime_hard_correct4);
}

let anime_hard_incorrect4 = sessionStorage.getItem('anime_hard_incorrect4');
function incorrectD(){
	anime_hard_incorrect4++
	sessionStorage.setItem('anime_hard_incorrect4',anime_hard_incorrect4);
}

let anime_hard_correct5 = sessionStorage.getItem('anime_hard_correct5');
function correctE(){
	anime_hard_correct5++
	sessionStorage.setItem('anime_hard_correct5',anime_hard_correct5);
}

let anime_hard_incorrect5 = sessionStorage.getItem('anime_hard_incorrect5');
function incorrectE(){
	anime_hard_incorrect5++
	sessionStorage.setItem('anime_hard_incorrect5',anime_hard_incorrect5);
}
