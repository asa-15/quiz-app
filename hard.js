...
//セッションストレージ
let hard_correct1 = sessionStorage.getItem('hard_correct1');
function correct(){
	hard_correct1++
	sessionStorage.setItem('hard_correct1',hard_correct1);
}

let hard_incorrect1 = sessionStorage.getItem('hard_incorrect1');
function incorrect(){
	hard_incorrect1++
	sessionStorage.setItem('hard_incorrect1',hard_incorrect1);
}

let hard_correct2 = sessionStorage.getItem('hard_correct2');
function correctB(){
	hard_correct2++
	sessionStorage.setItem('hard_correct2',hard_correct2);
}

let hard_incorrect2 = sessionStorage.getItem('hard_incorrect2');
function incorrectB(){
	hard_incorrect2++
	sessionStorage.setItem('hard_incorrect2',hard_incorrect2);
}

let hard_correct3 = sessionStorage.getItem('hard_correct3');
function correctC(){
	hard_correct3++
	sessionStorage.setItem('hard_correct3',hard_correct3);
}

let hard_incorrect3 = sessionStorage.getItem('hard_incorrect3');
function incorrectC(){
	hard_incorrect3++
	sessionStorage.setItem('hard_incorrect3',hard_incorrect3);
}

let hard_correct4 = sessionStorage.getItem('hard_correct4');
function correctD(){
	hard_correct4++
	sessionStorage.setItem('hard_correct4',hard_correct4);
}

let hard_incorrect4 = sessionStorage.getItem('hard_incorrect4');
function incorrectD(){
	hard_incorrect4++
	sessionStorage.setItem('hard_incorrect4',hard_incorrect4);
}

let hard_correct5 = sessionStorage.getItem('hard_correct5');
function correctE(){
	hard_correct5++
	sessionStorage.setItem('hard_correct5',hard_correct5);
}

let hard_incorrect5 = sessionStorage.getItem('hard_incorrect5');
function incorrectE(){
	hard_incorrect5++
	sessionStorage.setItem('hard_incorrect5',hard_incorrect5);
}
