...
//セッションストレージ
let correct1 = sessionStorage.getItem('correct1');
function correct(){
	correct1++
	sessionStorage.setItem('correct1',correct1);
}

let incorrect1 = sessionStorage.getItem('incorrect1');
function incorrect(){
	incorrect1++
	sessionStorage.setItem('incorrect1',incorrect1);
}

let correct2 = sessionStorage.getItem('correct2');
function correctB(){
	correct2++
	sessionStorage.setItem('correct2',correct2);
}

let incorrect2 = sessionStorage.getItem('incorrect2');
function incorrectB(){
	incorrect2++
	sessionStorage.setItem('incorrect2',incorrect2);
}

let correct3 = sessionStorage.getItem('correct3');
function correctC(){
	correct3++
	sessionStorage.setItem('correct3',correct3);
}

let incorrect3 = sessionStorage.getItem('incorrect3');
function incorrectC(){
	incorrect3++
	sessionStorage.setItem('incorrect3',incorrect3);
}

let correct4 = sessionStorage.getItem('correct4');
function correctD(){
	correct4++
	sessionStorage.setItem('correct4',correct4);
}

let incorrect4 = sessionStorage.getItem('incorrect4');
function incorrectD(){
	incorrect4++
	sessionStorage.setItem('incorrect4',incorrect4);
}

let correct5 = sessionStorage.getItem('correct5');
function correctE(){
	correct5++
	sessionStorage.setItem('correct5',correct5);
}

let incorrect5 = sessionStorage.getItem('incorrect5');
function incorrectE(){
	incorrect5++
	sessionStorage.setItem('incorrect5',incorrect5);
}
