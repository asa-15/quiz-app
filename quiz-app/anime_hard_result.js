let a = sessionStorage.getItem('anime_hard_correct1');
let co1 = Number(a)

let b = sessionStorage.getItem('anime_hard_incorrect1');
let ic1 = Number(b)
let total1 = co1 + ic1
...
let c = sessionStorage.getItem('anime_hard_correct2');
let co2 = Number(c)

let d = sessionStorage.getItem('anime_hard_incorrect2');
let ic2 = Number(d)
let total2 = co2 + ic2
...
let e = sessionStorage.getItem('anime_hard_correct3');
let co3 = Number(e)

let f = sessionStorage.getItem('anime_hard_incorrect3');
let ic3 = Number(f)
let total3 = co3 + ic3
...
let g = sessionStorage.getItem('anime_hard_correct4');
let co4 = Number(g)

let h = sessionStorage.getItem('anime_hard_incorrect4');
let ic4 = Number(h)
let total4 = co4 + ic4
...
let j = sessionStorage.getItem('anime_hard_correct5');
let co5 = Number(j)

let k = sessionStorage.getItem('anime_hard_incorrect5');
let ic5 = Number(k)
let total5 = co5 + ic5
