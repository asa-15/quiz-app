let a = sessionStorage.getItem('correct1');
let co1 = Number(a)

let b = sessionStorage.getItem('incorrect1');
let ic1 = Number(b)
let total1 = co1 + ic1
...
let c = sessionStorage.getItem('correct2');
let co2 = Number(c)

let d = sessionStorage.getItem('incorrect2');
let ic2 = Number(d)
let total2 = co2 + ic2
...
let e = sessionStorage.getItem('correct3');
let co3 = Number(e)

let f = sessionStorage.getItem('incorrect3');
let ic3 = Number(f)
let total3 = co3 + ic3
...
let g = sessionStorage.getItem('correct4');
let co4 = Number(g)

let h = sessionStorage.getItem('incorrect4');
let ic4 = Number(h)
let total4 = co4 + ic4
...
let j = sessionStorage.getItem('correct5');
let co5 = Number(j)

let k = sessionStorage.getItem('incorrect5');
let ic5 = Number(k)
let total5 = co5 + ic5
...
for(i in json){
 if(n[x] == "True"){
  ...
  graphs += `<h2>${ax[x].text}&ensp;正解は${ax[x].value}</h2><p>正解${json[x].result}人 不正解${json[x].result2}人</p>
  <div class = "allim"><div class ="marubatsu">${ans}</div><div class ="mbb"> <img class = img"" src =images/R.png></div></div></div>
